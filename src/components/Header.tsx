...
const Header: React.FC = () => {
    return (
        <header className="header">
            ...
            <div className='nav'>
                <a href="" className='nav_a'>Products</a>
                <a href="" className='nav_a'>Features</a>
                <a href="" className='nav_a'>Comments</a>
            </div>
            <div className='btm_container'>
                <div className='btm_cirkl'>
                    <button type="button" className='btm'>
                        Star free trial
                    </button>
                </div>
            </div>
